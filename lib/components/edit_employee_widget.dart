...
import 'edit_employee_model.dart';
export 'edit_employee_model.dart';

class EditEmployeeWidget extends StatefulWidget {
  const EditEmployeeWidget({
    Key? key,
    this.employeeRef,
  }) : super(key: key);
  ...
  @override
  _EditEmployeeWidgetState createState() => _EditEmployeeWidgetState();
}

class _EditEmployeeWidgetState extends State<EditEmployeeWidget> {
  late EditEmployeeModel _model;
            ...
            children: [
              Padding(
                ...
                child: StreamBuilder<EmployeeRecord>(
                  stream: EmployeeRecord.getDocument(widget.employeeRef!),
                  builder: (context, snapshot) {
                    ...
                    final containerEmployeeRecord = snapshot.data!;
                    return Material(
                                ...
                                children: [
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'xg8v4ks9' /* Mitarbeiter bearbeiten */,
                                          ),
                                  ...
                                  TextFormField(
                                    controller: _model.nameController1 ??=
                                      ...
                                      text: containerEmployeeRecord.name,
                                    ),
                                    autofocus: true,
                                    obscureText: false,
                                      ...
                                      Expanded(
                                        child: TextFormField(
                                          controller: _model.textController5 ??=
                                              TextEditingController(
                                            text: containerEmployeeRecord.phone,
                                          ),
                                          autofocus: true,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model.textController8 ??=
                                            TextEditingController(
                                          text: containerEmployeeRecord.street,
                                        ),
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: FFButtonWidget(
                                            ...
                                            text: FFLocalizations.of(context)
                                                .getText(
                                              '0dr7y7ge' /* Mitarbeiter aktualisieren */,
                                            ),
                                            options: FFButtonOptions(
                                              height: 40.0,
                                              padding: EdgeInsetsDirectional
