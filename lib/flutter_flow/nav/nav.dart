...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomePageWidget() : RegistrationWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => EmployeeDetailsWidget(
            employeeRefeence: params.getParam('employeeRefeence',
                ParamType.DocumentReference, false, ['employee']),
          ),
        ),
        FFRoute(
          name: 'selectFirm',
